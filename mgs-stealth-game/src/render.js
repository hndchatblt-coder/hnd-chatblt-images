...
(function (Game) {
  function createRenderer(opts) {
    ...
    var CONE_Y = 0.02;
    var CONE_STYLE = {
      PATROL: { color: 0x2e7d32, opacity: 0.18 },
      SUSPICIOUS: { color: 0xf9a825, opacity: 0.25 },
      INVESTIGATE: { color: 0xef6c00, opacity: 0.25 },
      ALERT: { color: 0xc62828, opacity: 0.3 },
      EVASION: { color: 0x6a1b9a, opacity: 0.25 },
      CAUTION: { color: 0xff8f00, opacity: 0.22 },
    };
    ...
    function updateGuardMarker(actor, guard) {
      ...
      actor.marker.position.set(guard.x, h + 1.3, guard.y);
    }
    ...
    function updateMeter(engine) {
      ...
      var y = stanceHeight(player.stance) + 0.45;
