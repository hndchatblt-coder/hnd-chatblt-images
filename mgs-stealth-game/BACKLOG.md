...
10. Remaining zones | content | L→split | Expression | ~~Warehouse~~ c15. ~~cameras system~~ c23. ~~Laboratory zone (lasers + keycards L1-L3 + doors + camera installation)~~ DONE this cycle. Next: Comms Tower (heavy patrols, finale) — stub exit already live at laboratory.exits[0] (to: "commsTower").
