...
UA.landmark = (icon, col, col2) => {
  const map = {
    ...
    falls: `<path d="M26 26 H94 V40 Q60 48 26 40Z" fill="#7FA8C0" ${OL}/>
      <path d="M38 40 Q36 74 28 92 H92 Q84 74 82 40 Q60 47 38 40Z" fill="#8FD9F2" ${OL}/>
      <path d="M48 45 Q46 72 40 90 M60 47 Q60 74 60 92 M72 45 Q74 72 80 90" stroke="#fff" stroke-width="5" fill="none" opacity=".85" stroke-linecap="round"/>
      <ellipse cx="60" cy="96" rx="40" ry="11" fill="#BFF0FA" ${OL}/>
      <circle cx="30" cy="90" r="4" fill="#fff" opacity=".9"/><circle cx="90" cy="88" r="5" fill="#fff" opacity=".9"/><circle cx="24" cy="82" r="3" fill="#fff" opacity=".8"/>`,
